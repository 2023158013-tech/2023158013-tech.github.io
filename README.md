...
#### 📦 [<span style="color: #1e88e5;">모듈 5: 보안/데이터 통합 개발 및 AI 서빙·RAG 시스템 학습</span>](/module5/README)
* **팀 구성**: 백엔드 5명(JSON 응답) / 프론트 2명
...
#### 📦 [<span style="color: #1e88e5;">모듈 6: 정산·재무 데이터 정합성과 동시성 제어, 성능 최적화</span>](/module6/README)
* **팀 구성**: 백엔드 6명(JSON 응답) / 프론트 2명
* 은행별 CSV 양식을 2축으로 추상화하고 4단계에 걸쳐 중복 검증 기준을 확장해 정산·재무 데이터 정합성 확보
* 세금계산서·입출금 매칭에 상황별 동시성 제어(`FOR UPDATE`/조건부 UPDATE) 적용, `EXPLAIN` 실측 기반 성능 최적화
